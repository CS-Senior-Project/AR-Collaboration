...
public class Packet : IDisposable
{
    ...
    /*public void Write(float[] _values)
    {
    ...
    /*public float[] ReadFloatArray(int length, bool _moveReadPos = true) //will probably have to change later, but will use for now
    {
        float[] _data = new float[length];
        for (int i = 0; i < length; i++)
        {
            _data[i] = ReadFloat(_moveReadPos);
        }
